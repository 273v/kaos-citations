...
See [CONTRIBUTING.md](https://github.com/273v/kaos-citations/blob/main/CONTRIBUTING.md)
...
- [ ] `uv run ruff format --check kaos_citations tests` passes
- [ ] `uv run ruff check kaos_citations tests` passes
- [ ] `uv run ty check kaos_citations tests` passes
