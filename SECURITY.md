...
vulnerability in `kaos-citations`, please report it privately so we can address it
...
Use [GitHub Private Vulnerability Reporting](https://github.com/273v/kaos-citations/security/advisories/new)
...
`kaos-citations` follows Semantic Versioning. While the project is pre-1.0, only
...
- The `kaos-citations` Python package as published on PyPI
- The `273v/kaos-citations` GitHub repository (CI, release, supply chain)
