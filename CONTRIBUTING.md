...
`kaos-citations` requires Python 3.13 or newer. It publishes the `kaos_citations`
import package. This package publishes CLI entry point(s): `kaos-citations-serve`.
Public extras currently declared: `legal`.
...
include the `kaos-citations` version, Python version, operating system,
